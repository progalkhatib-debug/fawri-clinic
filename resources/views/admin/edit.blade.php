    ...
    <form action="{{ route('appointments.update', $appointment->id) }}" method="POST" enctype="multipart/form-data">
        ...
        <div class="mb-6">
            ...
            @if(isset($appointment) && $appointment->prescription_image)
                <div class="mt-3">
                    <!-- رابط عرض الروشتة المرفوعة مسبقاً متوافق مع Base64 -->
                    <a href="{{ $appointment->prescription_image }}" target="_blank" class="text-blue-600 font-bold underline text-sm inline-flex items-center gap-1">
