...
<head>
    ...
    <meta property="og:image" content="https://fawri-clinic.onrender.com/images/barcode.png">
...
<div class="md:w-1/2 p-3 md:p-6"> 
    ...
    <input type="text" id="appointment_date_view" placeholder="تحديد التاريخ" readonly required class="w-full p-3 pl-10 border rounded-lg bg-white cursor-pointer text-right appearance-none">
